...
class _RealtimeChatScreenState extends State<RealtimeChatScreen> with WidgetsBindingObserver {
  ...
  void didChangeDependencies() {
    ...
    void init() {
      messagesController =
          RealtimeChatPageController(conversationId: args.conversationId, scrollToBottom: scrollToBottom, scrollController: scrollController);
      addMessageToQueueController = MessageInputController(
          text: '', scrollToBottom: scrollToBottom, conversationId: args.conversationId, getParticipants: () => messagesController.getParticipants());
    ...
    if (args.uidForDirectConversation != null) {
      ...
      WidgetsBinding.instance.addPostFrameCallback((_) {
        getIt
            .get<MessagesService>()
            .createConversationIfDoesntExists(uidForDirectConversation: args.uidForDirectConversation!)
            .then((conversationId) {
                  ...
                  builder: (context, conversationSnapshot) {
                    ...
                    return FutureBuilder(
                        future: conversationSnapshot.data!.isGroup
                            ...
                            : getIt
                                .get<UsersService>()
                                .getUser(uid: conversationSnapshot.data!.participants.firstWhere((uid) => uid != getIt.get<AuthService>().loggedUid)),
                              ...
                              onTap: !conversationSnapshot.data!.isGroup
                                  ...
                                  : () {
                                        ...
                                        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                                          ...
                                          content: Row(
                                            ...
                                            children: [
                                              ...
                                              Text('Only Admins can edit group settings',
                                      ...
                                      Navigator.of(context)
                                          .pushNamed(ScreenRoutes.createGroupOrEditTitle,
                                              arguments: CreateGroupOrEditTitleArgs(editExistingConversationId: args.conversationId))
                                          .then((_) {
                                        setState(() {});
                                      });
                                    },
                                  ...
                                  children: [
                                    ListView.builder(
                                      ...
                                      itemBuilder: (BuildContext context, int index) {
                                        return Container(
                                          child: Padding(
                                            padding: index < snapshot.data!.length - 1 ? EdgeInsets.zero : const EdgeInsets.only(bottom: 15),
                                        ...
                                        builder: (context, unreadMessagesAtTheBottom, _) {
                                          return AnimatedSwitcher(
                                              ...
                                              child: !unreadMessagesAtTheBottom
                                                  ? Container(
                                                      key: const Key('hide_go_to_bottom'),
                                                    )
                                                  : InkWell(
                                                          ...
                                                          children: [
                                                            ...
                                                            Container(
                                                              ...
                                                              decoration: BoxDecoration(
                                                                  color: Colors.green[500], borderRadius: BorderRadius.all(Radius.circular(100))),
  ...
  bool sentByLoggedUser(ChatListItemEntity data) =>
      (data is MessageChatListItemEntity && data.message.senderUid == loggedUid) && data is! TypingIndicatorWidget;
...
class _AnimatedSuffixIconForMessage extends StatelessWidget {
  ...
  const _AnimatedSuffixIconForMessage({required this.showTextSentIcon, required this.sendEnabled, this.addMessageToQueue, Key? key})
      : super(key: key);
