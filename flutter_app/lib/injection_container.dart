...
Future<void> init() async {
  ...
  getIt.registerLazySingleton(
      () => MessagesDS(authService: getIt.get<AuthService>(), firestore: FirebaseFirestore.instance, typingDs: getIt.get<TypingDS>()));
  ...
  getIt.registerLazySingleton(() =>
      MessagesService(usersService: getIt.get<UsersService>(), authService: getIt.get<AuthService>(), messagesDatasource: getIt.get<MessagesDS>()));
